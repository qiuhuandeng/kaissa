(function () {
  ...
  ui.mount(host, { title: '资金分析', showTitle: false, views: m.views, defaults: m.defaults, query: m.query, labels, money, columns: q => columns[q.view], extras: ['number', 'party', 'converted', 'rate', 'rateDate', 'rateProof', 'recorded', 'peer', 'prepay', 'due', 'obligation', 'replacedBy', 'commitment', 'offsetProof', 'order', 'purchase'], filters: [
