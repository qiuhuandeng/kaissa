(function () {
  ...
  ui.mount(host, { title: '发票与收付款核对', showTitle: false, views: m.views, defaults: m.defaults, query: m.query, labels, money: ['cash', 'invoiced', 'gap', 'amount', 'allocated', 'unallocated'], columns: () => ['id', 'party', 'company', 'currency', 'cash', 'invoiced', 'gap', 'due', 'status'], extras: ['invoiceIds', 'cashIds', 'partyId', 'invoiceDue', 'cashDue', 'proof'], filters: [
    { key: 'dataset', label: '资料范围', options: [['pending', '来源待接入'], ['demo', '正常验收算例'], ['gaps', '含来源缺口算例']] },
