(function () {
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          title: "呼叫中心",
          children: [
            { title: "电销意向", href: "sales/call-center/intents.html" },
            { title: "电销顾问", href: "sales/call-center/consultants.html" },
            { title: "电销业绩", href: "sales/call-center/performance.html" },
          ],
        },
      ],
    },
      ...
      children: [
        {
          ...
          children: [
            ...
            { title: "转款处理", href: "finance/finance-transfer-records.html" },
          ],
        },
        {
          title: "成本应付",
  ...
  const pageOwners = {
    ...
    "resource/supplier-requests.html": { href: "resource/suppliers.html", title: "合作申请" },
    ...
    "sales/store/reconciliation.html": { href: "sales/store/reconciliation.html", title: "门店对帐" },
    "sales/consultant/index.html": { href: "sales/store/members.html", title: "门店成员" },
    "sales/consultant/detail.html": { href: "sales/store/members.html", title: "顾问详情" },
    ...
    "finance/finance-advance-receipts.html": { href: "finance/finance-advance-receipts.html", title: "预收管理" },
    "finance/finance-predeposit.html": { href: "finance/finance-predeposit.html", title: "预存账户" },
    "finance/finance-transfer-records.html": { href: "finance/finance-transfer-records.html", title: "转款处理" },
    "finance/finance-refund-execute.html": { href: "finance/finance-refund-execute.html", title: "退款执行" },
    "finance/finance-payment-apply.html": { href: "finance/finance-payment-apply.html", title: "付款申请" },
    "finance/finance-payment.html": { href: "finance/finance-payment.html", title: "付款执行" },
    "finance/finance-payment-return.html": { href: "finance/finance-payment-return.html", title: "付款退回" },
    "finance/finance-remittance.html": { href: "finance/finance-remittance.html", title: "回单核销" },
  ...
  window.caesarCompanyContext = () => ({company:currentSubject().name,department:currentScope().name});
  function refreshOrgTopbar() {
    ...
    window.dispatchEvent(new CustomEvent("caesar-company-change", {detail:window.caesarCompanyContext()}));
  }
  ...
  const metaTagTexts = new Set([
    ...
    "成人/儿童对客价", "舱型库存价", "铺位/包厢结算价", "服务费/加急费",
  ...
  function classifyTableColumn(title, index, headerCell) {
    ...
    if (/图片|线路图|封面|头像|Logo|图标/.test(text)) return "visual";
    if (/线路\/|线路名称|线路\/|资源名称|供应商名称|客户\/渠道|客户\/联系人|项目\/客户|项目名称|公司名称|门店名称|商户名称|租户名称|组织名称|部门名称|角色名称|员工账号|船只名称|船名|船公司名称|酒店名称|餐厅名称|车型名称|套餐名称|模板名称|规则名称|策略名称|任务名称/.test(text)) return "main";
